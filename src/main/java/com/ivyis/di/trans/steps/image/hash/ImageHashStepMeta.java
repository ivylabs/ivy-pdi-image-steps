package com.ivyis.di.trans.steps.image.hash;
...
import com.ivyis.di.ui.trans.steps.image.ImageHashStepDialog;
 ...
 * @since 1.0.0
 */
@Step(id = "ImageHashStep", name = "ImageHashStep.Step.Name",
    description = "ImageHashStep.Step.Description",
    categoryDescription = "ImageHashStep.Step.Category",
    image = "com/ivyis/di/trans/steps/image/ImageHashStep.png",
...
public class ImageHashStepMeta extends BaseStepMeta implements StepMetaInterface {

  /** for i18n purposes. **/
  private static final Class<?> PKG = ImageHashStepMeta.class;
  ...
  public StepDialogInterface getDialog(Shell shell, StepMetaInterface meta, TransMeta transMeta,
      String name) {
    return new ImageHashStepDialog(shell, (BaseStepMeta) meta, transMeta, name);
  }
  ...
  public StepInterface getStep(StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr,
      TransMeta transMeta,
      Trans disp) {
    return new ImageHashStep(stepMeta, stepDataInterface, cnr, transMeta, disp);
  }
