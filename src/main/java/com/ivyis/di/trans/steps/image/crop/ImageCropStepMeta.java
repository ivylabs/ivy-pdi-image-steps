...
import com.ivyis.di.ui.trans.steps.image.ImageCropStepDialog;
 ...
 * @since 1.0.0
 */
@Step(id = "ImageCropStep", name = "ImageCropStep.Step.Name",
    description = "ImageCropStep.Step.Description",
    categoryDescription = "ImageCropStep.Step.Category",
    image = "com/ivyis/di/trans/steps/image/ImageCropStep.jpg",
...
public class ImageCropStepMeta extends BaseStepMeta implements StepMetaInterface {

  /** for i18n purposes. **/
  private static final Class<?> PKG = ImageCropStepMeta.class;

  private String fileFromPath, fileToPath, axisX, axisY, targetWidth, targetHeight = null;
  ...
  public String getXML() {
    ...
    retval.append("    " + XMLHandler.addTagValue("axisX", axisX));
    retval.append("    " + XMLHandler.addTagValue("axisY", axisY));
  ...
  public void readRep(Repository rep, ObjectId idStep, List<DatabaseMeta> databases,
    ...
    try {
      ...
      axisX = rep.getStepAttributeString(idStep, "axisX");
      axisY = rep.getStepAttributeString(idStep, "axisY");
      ...
      throw new KettleException(BaseMessages.getString(PKG,
          "ImageCrop.Exception.UnexpectedErrorInReadingStepInfo"), e);
    }
  }
  ...
  public void saveRep(Repository rep, ObjectId idTransformation, ObjectId idStep)
    ...
    try {
      ...
      rep.saveStepAttribute(idTransformation, idStep, "axisX", axisX);
      rep.saveStepAttribute(idTransformation, idStep, "axisY", axisY);
      ...
      throw new KettleException(BaseMessages.getString(PKG,
          "ImageCrop.Exception.UnableToSaveStepInfoToRepository") + idStep, e);
    }
  }
  ...
  public void readData(Node stepnode) throws KettleXMLException {
    try {
      ...
      axisX = XMLHandler.getTagValue(stepnode, "axisX");
      axisY = XMLHandler.getTagValue(stepnode, "axisY");
  ...
  public StepDialogInterface getDialog(Shell shell, StepMetaInterface meta, TransMeta transMeta,
      String name) {
    return new ImageCropStepDialog(shell, (BaseStepMeta) meta, transMeta, name);
  }
  ...
  public StepInterface getStep(StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr,
      TransMeta transMeta,
      Trans disp) {
    return new ImageCropStep(stepMeta, stepDataInterface, cnr, transMeta, disp);
  }
