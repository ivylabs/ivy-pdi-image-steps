 ...
 * @since 1.0.0
 */
public class ImageHashStep extends BaseStep implements StepInterface {

  /** for i18n purposes. **/
  private static final Class<?> PKG = ImageHashStep.class;
  private ImageHashStepMeta meta;
  private ImageHashStepData data;
  ...
  public boolean processRow(StepMetaInterface smi, StepDataInterface sdi) throws KettleException {
    this.meta = (ImageHashStepMeta) smi;
    this.data = (ImageHashStepData) sdi;
  ...
  public boolean init(StepMetaInterface smi, StepDataInterface sdi) {
    meta = (ImageHashStepMeta) smi;
    data = (ImageHashStepData) sdi;
