...
public class ImageResizeStep extends BaseStep implements StepInterface {
    ...
    public ImageResizeStep(StepMeta s, StepDataInterface stepDataInterface, int c, TransMeta t, Trans dis) {
    ...
    public boolean processRow(StepMetaInterface smi, StepDataInterface sdi) throws KettleException {
        ...
        try {
            ...
            if (log.isDetailed()) {
                logDetailed("New File Path: '" + fileToPath + "', Size - Width: " + ip2.getWidth() + ", Height: "
                        + ip2.getHeight());
            }
