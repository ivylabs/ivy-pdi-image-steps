...
public enum ConverterType {
    ...
    HSB_TO_RGB("HSBToRGB"), RGB_STACK_TO_RGB("RGBStackToRGB"), TO_GRAY_16("ToGray16"), TO_GRAY_32("ToGray32"), TO_GRAY_8(
    ...
    public static String[] getConverterTypesLabel() {
        ...
        for (ConverterType type : ConverterType.values()) {
            converterTypes[i++] = BaseMessages.getString(PKG, "ImageConverter." + type.getType() + ".Label");
        }
